    ...
    <div className="max-w-4xl mx-auto py-12 px-6 text-white">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-200 leading-relaxed">
              Tempo Tuition is a music education service operating in Bristol and the surrounding
              areas. We connect students with qualified music tutors for lessons in guitar, piano,
          ...
          <div>
            ...
            <p className="text-gray-200 leading-relaxed mb-3">
              When you enquire about or book music lessons with us, we collect the following
              information:
            </p>
            <ul className="list-disc ml-6 text-gray-200 space-y-2">
              ...
              <li>
                Learning preferences: Instruments of interest, experience level, learning goals
              </li>
          ...
          <div>
            ...
            <ul className="list-disc ml-6 text-gray-200 space-y-2">
              ...
              <li>
                To share your details with approved tutors who can provide the lessons you need
              </li>
          ...
          <div>
            ...
            <p className="text-gray-200 leading-relaxed mb-3">We share your information with:</p>
            <ul className="list-disc ml-6 text-gray-200 space-y-2">
              <li>
                <strong>Approved Music Tutors:</strong> We share relevant details with vetted,
                qualified tutors who can provide the lessons you&apos;re looking for
              </li>
              <li>
                <strong>Service Providers:</strong> Email services for communications and secure
            ...
            <p className="text-gray-200 leading-relaxed mt-3">
              We do not sell your personal information to third parties or use it for marketing
              purposes beyond our own services.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-200 leading-relaxed">
              ...
              required by law. All our tutors are required to handle your personal information in
          ...
          <div>
            ...
            <p className="text-gray-200 leading-relaxed">
              Our website may use cookies to improve your browsing experience. These are typically
              used for functionality purposes and to remember your preferences. You can control
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-200 leading-relaxed">
              Tempo Tuition provides a connection service between students seeking music lessons and
              qualified music tutors. We facilitate introductions but do not directly provide the
          ...
          <div>
            ...
            <p className="text-gray-200 leading-relaxed">
              Once we connect you with a suitable tutor, lesson arrangements, scheduling, payments,
              and policies are managed directly between you and the tutor. We carefully vet our
              tutors, but each operates as an independent contractor with their own terms and
              teaching methods.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-200 leading-relaxed">
              By submitting an enquiry through our website, you consent to us sharing your
              information with appropriate tutors in your area. There is no obligation to proceed
              with lessons after making an enquiry.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-200 leading-relaxed">
              You agree to provide accurate and complete information when making an enquiry. This
              helps us match you with the most suitable tutors for your needs.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-200 leading-relaxed">
              Tempo Tuition acts as an introduction service. We are not liable for the quality of
              lessons, tutor conduct, payment disputes, or any issues arising from the direct
              relationship between students and tutors. However, we are committed to working with
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          <p className="text-gray-200 leading-relaxed">
            ...
            exercise any of your data protection rights, please contact us:
          </p>
          <div className="bg-gray-800 p-6 rounded-lg">
            <p className="text-white mb-2">
              <strong>Email:</strong> jim@tempotuition.co.uk
            </p>
            <p className="text-white mb-2">
              <strong>Response Time:</strong> We aim to respond to all privacy-related enquiries
              within 30 days
            </p>
            <p className="text-white">
              <strong>Data Protection:</strong> We are committed to GDPR compliance and protecting
      ...
      <div className="border-t border-gray-300 pt-6">
        <p className="text-gray-200 text-sm">
          This privacy policy and terms of service comply with UK GDPR requirements and are
          regularly reviewed to ensure continued compliance.
        </p>
      </div>
    </div>
  );
