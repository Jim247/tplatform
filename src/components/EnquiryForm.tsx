    ...
    switch (step) {
      ...
      case 2:
        if (subStep === 'instruments') {
          ...
          const hasAtLeastOneCompleteStudent =
            fields.students.length > 0 &&
            fields.students.some((student) => {
          ...
          console.log(
            'Summary validation - at least one student complete:',
            hasAtLeastOneCompleteStudent
          );
