...
export default function ContactWidget() {
  return (
    <section className="max-w-lg mx-auto px-4 py-10 bg-grey rounded-2xl shadow-xl border border-gray-600/30 flex flex-col items-center text-center">
      ...
      <p className="text-gray-200 mb-8 text-lg">We&apos;re here to help! Reach out by phone or email and we'll get back to you as soon as possible.</p>
      <div className="flex flex-col gap-6 w-full">
        ...
        >
          <Icon path={mdiEmail} size={1.5} className="text-yellow-300 group-hover:text-black transition-colors duration-200" />
          Email Us
        </a>
      </div>
    </section>
